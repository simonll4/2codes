...
INICIO: SUB R0,R15,R15      ;seteo cero
        ADD R9,R0,#1        ;valor inicial de la secuencia = 1
        ADD R2,R0,#2        ;potencia de dos inicial = 2
        ADD R10,R0,#8        ;iteracion inicial loop 1 = 8
...
RETARDO 1:SUBS R4,R4,#1
        ...
        SUBS R10,R10,#1       ;condicion para finalizar loop 1
        BNE LOOP 1          ;finaliza secuencia de luces
        SUB R10,R5,#1        ;guardo en el iterador las iteraciones contadas menos 1
