...
//Implemente un apuntador de citas usando el concepto de cola circular implementada
//mediante el uso de un arreglo.

public class eje1 {
    public static void main(String[] args) {

        ArrayQueue<String> workDate = new ArrayQueue<>();
    ...
    public static void showWorkDate(ArrayQueue<String> workDate) throws Exception {
    ...
    public static void addWorkDate(ArrayQueue<String> workDate) {
        Scanner console = new Scanner(System.in);
    ...
    public static void deleteWorkDate(ArrayQueue<String> workDate) throws Exception {
